        ...
        <section className="py-10 bg-gray-100 sm:py-16 lg:py-28">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Login with just an email </h2>
                    <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">No remembering passwords! Enter your email and get a link that will sign you in to your profile. </p>
                </div>
