    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            ...
            {/* <Image 
                ...
                <p className="text-xl font-semibold text-gray-900">UpTap</p>
                <p className="text-base leading-relaxed text-gray-600 mt-7">Card stuff goes here </p>
            ...
            <div className="lg:col-span-2">
                ...
                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" className="flex text-sm text-gray-800 transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> Link </a>
                    </li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <p className="text-sm text-gray-600">© Copyright 2021, All Rights Reserved by UpTap.App</p>
