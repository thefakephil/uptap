...
export default function Feature() {
    // console.log('session passed', session.user.email)
    return (
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
                    <div>
                        ...
                        <p className="mt-4 text-sm text-gray-600"> Update your links - tap your card - share your details.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 className="mt-8 text-lg font-semibold text-black">Design First</h3>
                        <p className="mt-4 text-sm text-gray-600">Pick from a number of themes that put your information front and center</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 className="mt-8 text-lg font-semibold text-black">Third</h3>
                    ...
                    <div>
                        ...
                        <h3 className="mt-8 text-lg font-semibold text-black">Fourth</h3>
                        <p className="mt-4 text-sm text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                    </div>
                </div>
            </div>
